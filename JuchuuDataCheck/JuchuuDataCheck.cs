...
namespace JuchuuDataCheck
{
    /// <summary>
    /// JuchuuDataCheck 受注データチェック処理
    /// </summary>
    internal partial class JuchuuDataCheck : FrmMainForm
    {
        private const string ProID = "JuchuuDataCheck";
        private const string ProNm = "受注データチェック処理";
        private const short mc_L_END = 3; // ロック用

        private JuchuuDataCheck_BL nkbl;
        private D_Juchuu_Entity dje;
        private bool mAutoMode = false;

        public JuchuuDataCheck()
        {
            InitializeComponent();
