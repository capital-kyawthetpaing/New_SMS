...
namespace TempoRegiFurikomiYoushi.CR_regi1
{
    public partial class Youshi1 : Form
    {
        TempoRegiFurikomiYoushi_DL tdl;
        DataTable dtreport;
        Base_DL bdl;
        string[] lst = new string[] { };
        public Youshi1(DataTable dt, params string[] loginfo)
        {
        ...
        private void Youshi1_Load(object sender, EventArgs e)
        {
            Load_Report();
