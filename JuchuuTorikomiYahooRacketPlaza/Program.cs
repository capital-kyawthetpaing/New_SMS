...
namespace JuchuuTorikomiYahooRacketPlaza
{
    class Program
    {
        ...
        static string Shopname= "racket";//racket,luckpiece,sportsplaza,baseball,honpo,
        static DataTable dtMulti, dtApiControl;
        static void Main(string[] args)
        {
            Console.Title = "JuchuuTorikomiYahooRacketPlaza_受注取込(YahooRacketPlaza)";
