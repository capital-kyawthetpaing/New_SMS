 BEGIN TRY 
 Drop Procedure dbo.[INSERT_D_DepositHistory_Other]
END try
...
CREATE PROCEDURE [dbo].[INSERT_D_DepositHistory_Other]
(
    @SalesNO varchar(11),
    @SIGN int,
    @Operator  varchar(10),
...
BEGIN
    ...
    INSERT INTO [D_DepositHistory]
 	...
 	VALUES(
       ...
       ,@DenominationCD    --DenominationCD
       ,@SIGN*@OtherAmount   --DepositGaku
       ,NULL    --Remark
