...
--BEGIN TRY
    ...
    IF @SeqKBN = 13
    BEGIN
        SET @iCnt = (SELECT COUNT(M.TemporaryReserveCounter)
        ...
        IF @iCnt = 0
        BEGIN
            INSERT INTO [M_TemporaryReserve]
               ([TemporaryReserveKey]
               ,[TemporaryReserveCounter])
            VALUES
               (1	--[TemporaryReserveKey]
               ,0	--[TemporaryReserveCounter]
               );
        END
    ...
    BEGIN
        ...
        SET @iCnt = (SELECT COUNT(M.SeqNumber) FROM M_PrefixNumber M
