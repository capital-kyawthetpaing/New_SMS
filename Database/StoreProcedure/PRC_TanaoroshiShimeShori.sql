...
CREATE PROCEDURE [dbo].[PRC_TanaoroshiShimeShori](
    ...
    BEGIN
        ...
        INSERT INTO [D_Inventory]
     	...
     	SELECT 
           ...
           ,DS.AdminNO
           ,MAX(DS.JanCD)
           ,SUM(DS.StockSu) AS TheoreticalQuantity
           ,SUM(DS.StockSu) AS ActualQuantity
    ...
    -- ========= ループ内の実際の処理 ここから===
            ...
            BEGIN
                ...
                SET @StockNO = (SELECT top 1 DS.StockNO
                                ...
                                AND DS.ArrivalYetFLG = 0
                                ORDER BY (DS.StockSu - DS.AllowableSu) desc
                                ,DS.ArrivalDate
                                ,DS.StockNO
                                );
            ...
            BEGIN
                ...
                DECLARE CUR_AAA2 CURSOR FOR
                    ...
                    ORDER BY (DS.StockSu - DS.ReserveSu) desc
                    ,DS.ArrivalDate
                    ,DS.StockNO
                    ;
