 BEGIN TRY 
 Drop Procedure dbo.[INSERT_D_DepositHistory_Credit]
END try
...
CREATE PROCEDURE [dbo].[INSERT_D_DepositHistory_Credit]
(
    @SalesNO varchar(11),
    @SIGN int,
    @Operator  varchar(10),
    ...
    INSERT INTO [D_DepositHistory]
 	...
 	VALUES(
       ...
       ,(SELECT M.DenominationCD FROM M_DenominationKBN AS M
       	WHERE M.SystemKBN = 9 AND M.MainFLG = 1)    --DenominationCD
       ,@SIGN*@CresitAmount   --DepositGaku
       ,NULL    --Remark
