 BEGIN TRY 
 Drop Procedure dbo.[INSERT_D_DepositHistory_Cash]
END try
...
CREATE PROCEDURE [dbo].[INSERT_D_DepositHistory_Cash]
(
    @SalesNO varchar(11),
    @SIGN int,
    @Operator  varchar(10),
    ...
    INSERT INTO [D_DepositHistory]
 	...
 	VALUES(
       ...
       ,(SELECT M.DenominationCD FROM M_DenominationKBN AS M
       	WHERE M.SystemKBN = 1 AND M.MainFLG = 1)    --DenominationCD
       ,@SIGN*@CashAmount   --DepositGaku
       ,NULL    --Remark
