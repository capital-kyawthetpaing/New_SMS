...
CREATE PROCEDURE [dbo].[M_StoreClose_Update](
...
BEGIN
    ...
    BEGIN
        ...
        Update M_StoreClose SET
              ...
              ,[MonthlyClaimsFLG]      = (CASE @KBN WHEN 1 THEN 0    WHEN 3 THEN 0    WHEN 6 THEN 1            ELSE MonthlyClaimsFLG END)
              ,[MonthlyClaimsDateTime] = (CASE @KBN WHEN 1 THEN NULL WHEN 3 THEN NULL WHEN 6 THEN @SYSDATETIME ELSE MonthlyClaimsDateTime END)
              ,[MonthlyDebtFLG]        = (CASE @KBN WHEN 2 THEN 0    WHEN 4 THEN 0    WHEN 7 THEN 1            ELSE MonthlyDebtFLG END)
              ,[MonthlyDebtDateTime]   = (CASE @KBN WHEN 2 THEN NULL WHEN 4 THEN NULL WHEN 7 THEN @SYSDATETIME ELSE MonthlyDebtDateTime END)
