...
BEGIN
    ...
    BEGIN
        ...
        --【D_PurchaseDetailsHistory】Insert　Table転送仕様Ｄ　赤
        ...
        --行追加分
       --D_PurchaseDetails     Insert  Table転送仕様Ｂ
        ...
        --D_PurchaseHistory     Insert  Table転送仕様Ｃ
        --D_PurchaseDetailsHistory  Insert  Table転送仕様Ｄ
        EXEC INSERT_D_PurchaseHistory
            @PurchaseNO    -- varchar(11),
            ,1  --@RecoredKBN
            ,@SYSDATETIME   --  datetime,
        ...
        --D_CollectPlanDetails  Update Table転送仕様Ｉ②更新
        ...
        --D_Billing             Update Table転送仕様Ｊ②更新
        ...
        --D_BillingDetails  Update Table転送仕様Ｋ②更新
    ...
    BEGIN
        ...
        -- ========= ループ内の実際の処理 ここから===
            ...
            BEGIN
                ...
                --D_SalesDetails        Insert  Table転送仕様Ｇ
                INSERT INTO [D_SalesDetails]
                   ([SalesNO]
                   ,[SalesRows]
                   ,[JuchuuNO]
              ...
              ;
                ...
                --D_CollectPlan         Insert  Table転送仕様Ｈ
               ...
               ;
                ...
                --D_CollectPlanDetails  Insert  Table転送仕様Ｉ
               ...
               ;
                ...
                BEGIN
	                ...
	                --D_BillingDetails      Insert  Table転送仕様Ｋ
