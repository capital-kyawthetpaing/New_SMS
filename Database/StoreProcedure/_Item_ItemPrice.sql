...
--			select *  from #tempItem
	...
	select * FROM OPENXML (@DocHandle, '/NewDataSet/test',2)
			...
			,targ.GeneralPriceWithTax							=src.GeneralPriceWithTax	
			,targ.GeneralPriceOutTax							=src.GeneralPriceOutTax	
			--,targ.MemberRate									=src.MemberRate			
			,targ.MemberPriceWithTax							=src.MemberPriceWithTax	
			,targ.MemberPriceOutTax								=src.MemberPriceOutTax	
			--,targ.ClientRate									=src.ClientRate			
			,targ.ClientPriceWithTax							=src.ClientPriceWithTax	
			,targ.ClientPriceOutTax								=src.ClientPriceOutTax	
			--,targ.SaleRate										=src.SaleRate			
			,targ.SalePriceWithTax								=src.SalePriceWithTax	
			,targ.SalePriceOutTax								=src.SalePriceOutTax		
			--,targ.WebRate										=src.WebRate				
			,targ.WebPriceWithTax								=src.WebPriceWithTax		
			,targ.WebPriceOutTax								=src.WebPriceOutTax		
