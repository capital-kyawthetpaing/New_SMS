 BEGIN TRY 
 Drop Procedure dbo.[INSERT_D_DepositHistory_Point]
END try
...
CREATE PROCEDURE [dbo].[INSERT_D_DepositHistory_Point]
(
    @SalesNO varchar(11),
    @SIGN int,
    @Operator  varchar(10),
...
BEGIN
    ...
    INSERT INTO [D_DepositHistory]
 	...
 	VALUES(
       ...
       ,@RecoredKBN   --RecoredKBN 0:黒、1:赤
       ,(SELECT M.DenominationCD FROM M_DenominationKBN AS M
       	WHERE M.SystemKBN = 3 AND M.MainFLG = 1)    --DenominationCD
       ,@SIGN*@PointAmount   --DepositGaku
       ,NULL    --Remark
