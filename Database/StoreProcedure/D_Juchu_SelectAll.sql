...
/****** Object:  StoredProcedure [dbo].[D_Juchuu_SelectAll]    Script Date: 2019/09/15 19:54:54 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE D_Juchuu_SelectAll(
...
/*    LEFT OUTER JOIN (SELECT DM.JuchuuNO, MIN(DM.JuchuuRows) AS JuchuuRows
    ...
    ALTER TABLE [#TableForJuchuuShoukai] ADD PRIMARY KEY CLUSTERED ([JuchuuNO],[JuchuuRows])
    ...
    BEGIN
        ...
        BEGIN
            ...
            WHERE EXISTS(
                ...
                AND DM.JuchuuRows = #TableForJuchuuShoukai.JuchuuRows   
    ...
    */
    ...
    SELECT (CASE WHEN DH.JuchuuRows = DM.JuchuuRows THEN
                DH.StoreCD
                ELSE '' END) AS StoreCD
            ,(CASE WHEN DH.JuchuuRows = DM.JuchuuRows THEN
                DH.StoreName
    ...
    INNER JOIN (SELECT JuchuuNO, MIN(JuchuuRows) AS JuchuuRows FROM #TableForJuchuuShoukai
    			GROUP BY JuchuuNO ) DM ON DM.JuchuuNO = DH.JuchuuNO
    ORDER BY DH.JuchuuNO
    ;
END
