...
namespace BL
{
    public class MasterTouroku_ShiireTanka_BL : Base_BL
    {
        ...
        public bool Mastertoroku_Shiretanka_Insert(string tbitem, string tbsku,string tbdel, M_ItemOrderPrice_Entity mie)
        {
            return msdl.Mastertoroku_Shiretanka_Insert(tbitem,tbsku,tbdel,mie);
        }
