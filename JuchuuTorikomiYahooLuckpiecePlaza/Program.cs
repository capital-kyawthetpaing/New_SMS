...
namespace JuchuuTorikomiYahooLuckpiecePlaza
{
    class Program
    {
        ...
        static string Shopname = "luckpiece";//racket,luckpiece,sportsplaza,baseball,honpo,
        static DataTable dtMulti, dtApiControl;
        static void Main(string[] args)
        {
            Console.Title = "JuchuuTorikomiYahooluckpiecePlaza_受注取込(YahooluckpiecePlaza)";
