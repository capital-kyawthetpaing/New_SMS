...
namespace KeihiltiranHyou
{
    ...
    public partial class FrmKeihiltiranHyou : FrmMainForm
    {
        ...
        private void SetRequireField()
        {
            ...
            expense_timefrom.isClosing = false;
            expense_timeto.isClosing = false;
        }
        ...
        protected override void PrintSec()
        {
            ...
            if (ErrorCheck())
            {
                ...
                foreach (DataRow dr in table.Rows)
                    dr["CostGaku"] = string.IsNullOrEmpty(dr["CostGaku"].ToString()) ? "0" : dr["CostGaku"].ToString();
                try
                {
        ...
        {
            if (e.KeyCode == Keys.Enter)
            if (!expense_timefrom.TimeCheck() && (sender as Control).Name == "expense_timefrom")
            {
                //bbl.ShowMessage("E103");
                return;
            }
            ...
            {
                if (!expense_timeto.TimeCheck() && (sender as Control).Name == "expense_timeto")
                {
                    //bbl.ShowMessage("E103");
                    return;
                }
