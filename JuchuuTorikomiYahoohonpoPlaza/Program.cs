...
namespace JuchuuTorikomiYahoohonpoPlaza
{
    class Program
    {
        ...
        static string Shopname = "honpo";//racket,luckpiece,sportsplaza,baseball,honpo,
        static DataTable dtMulti, dtApiControl;
        static void Main(string[] args)
        {
            Console.Title = "JuchuuTorikomiYahoohonpoPlaza_受注取込(YahoohonpoPlaza)";
