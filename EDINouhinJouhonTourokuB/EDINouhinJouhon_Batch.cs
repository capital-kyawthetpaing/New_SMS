    ...
    public class EDINouhinJouhon_Batch
    {
        ...
        public void PrepareImportData(string filePath)
        {
            try
            {
                ...
                String[] colNameD = { "レコード区分", "データ区分", "取引先会社部署CD", "取引先企業部署名", "納品元会社部署CD", "納品元企業部署名", "販売店会社部署CD", "販売店会社部署名", "出荷先会社部署CD", "出荷先会社部署名", "納品書NO", "納品書NO行", "納品書NO列", "伝票区分", "受注日", "出荷日", "納品/返品伝票日", "発注NO", "発注区分", "発注者商品CD", "納品元品番", "メーカー規格1", "メーカー規格2", "単位", "取引単価", "標準上代", "ブランド略名", "商品略名", "AdminNO", "JANCD", "納品数", "メーカー伝票NO", "元伝NO","予備1", "予備2", "予備3", "予備4", "予備5" };
                dtImport = null;
