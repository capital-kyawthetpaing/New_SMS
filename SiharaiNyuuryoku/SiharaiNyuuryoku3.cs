...
{
    public partial class SiharaiNyuuryoku2 : FrmMainForm
    {
        ...
        private void SetRequireField()
        {
            ...
            ScPaymentDestination.TxtCode.Require(true);
        ...
        private void F11()
        {
            ...
            if(ErrorCheck(11))
            {
                ...
                dppe.PayeeCD = ScPaymentDestination.TxtCode.Text;
        ...
        private bool ErrorCheck(int index)
        {
            if (index == 11)
            {
                ...
                if(type == 3 )
                {
                    if (!RequireCheck(new Control[] { ScPaymentDestination.TxtCode }))
                        return false;
                    else
                    {
                        mve.PayeeCD = ScPaymentDestination.TxtCode.Text;
                        ...
                        {
                            sibl.ShowMessage("115");
                            ScPaymentDestination.SetFocus(1);
                            return false;
                        }
                        else
                        {
                            ScPaymentDestination.LabelText = dtvendor.Rows[0]["VendorName"].ToString();
                        }
                    }
        ...
        private void ScPaymentNum_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void DataDisplay()
        {
            ...
            ScPaymentDestination.Enabled = false;
            ...
            if (dtPay.Rows.Count > 0)
            {
                ScPaymentDestination.TxtCode.Text = dtPay.Rows[0]["PayeeCD"].ToString();
                DataTable dtPayee = new DataTable();
                dpe.PayeeCD = ScPaymentDestination.TxtCode.Text;
                dpe.PayDate = DateTime.Now.ToShortDateString();
                dtPayee = sibl.M_Payee_Select(dpe);
                if (dtPayee.Rows.Count > 0)
                {
                    ScPaymentDestination.LabelText = dtPayee.Rows[0]["VendorName"].ToString();
                }
        ...
        private void ScPaymentProcessNum_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                type = 1;
