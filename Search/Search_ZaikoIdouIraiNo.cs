...
namespace Search
{
    public partial class Search_ZaikoIdouIraiNo : FrmSubForm
    {
        private const string ProNm = "移動依頼番号検索";
        ...
        public string RequestNO = string.Empty;
        ...
        public Search_ZaikoIdouIraiNo(string changeDate)
        {
            InitializeComponent();
        ...
        protected override void ExecDisp()
        {
            ...
            dpe = GetSearchInfo();
            DataTable dt = zibl.D_MoveRequest_SelectAll(dpe);
        ...
        private void GetData()
        {
            ...
            { 
                RequestNO = GvDetail.CurrentRow.Cells["colRequestNO"].Value.ToString();
            }
        }
