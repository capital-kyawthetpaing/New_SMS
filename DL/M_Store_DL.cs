    ...
    public class M_Store_DL : Base_DL
    {
        ...
        public bool M_Store_Exec(M_Store_Entity mbe, short operationMode, string operatorNm, string pc)
        {
            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                ...
                { "@Print1", new ValuePair { value1 = SqlDbType.VarChar, value2 = mbe.Print1} },
                { "@Print2", new ValuePair { value1 = SqlDbType.VarChar, value2 = mbe.Print2} },
                { "@Print3", new ValuePair { value1 = SqlDbType.VarChar, value2 = mbe.Print3} },
                { "@Print4", new ValuePair { value1 = SqlDbType.VarChar, value2 = mbe.Print4} },
