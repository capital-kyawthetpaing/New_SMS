    ...
    public class Search_TenzikaiShouhin_DL:Base_DL
    {
        ...
        public DataTable M_Tenzikaishouhin_Search(M_TenzikaiShouhin_Entity mt)
        {
            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                ...
                { "@insertdateT", new ValuePair { value1 = SqlDbType.TinyInt, value2 = mt.InsertDateTo} },
                { "@updatedateF", new ValuePair { value1 = SqlDbType.TinyInt, value2 = mt.UpdateDateFrom} },
                { "@updatedateT",new ValuePair{value1=SqlDbType.TinyInt,value2= mt.UpdateDateTo} },
