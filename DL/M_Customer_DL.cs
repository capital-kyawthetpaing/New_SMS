    ...
    public class M_Customer_DL : Base_DL
    {
        ...
        public bool M_Customer_Exec(M_Customer_Entity me, short operationMode)
        {
            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                ...
                { "@CreditCheckKBN", new ValuePair { value1 = SqlDbType.TinyInt , value2 = me.CreditCheckKBN } },
                { "@CreditMessage", new ValuePair { value1 = SqlDbType.VarChar , value2 = me.CreditMessage } },
                { "@FareLevel", new ValuePair { value1 = SqlDbType.Money , value2 = me.FareLevel } },
                { "@Fare", new ValuePair { value1 = SqlDbType.Money , value2 = me.Fare } },
