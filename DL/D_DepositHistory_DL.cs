   ...
   public class D_DepositHistory_DL : Base_DL
    {
        public bool D_DepositＨistory_Insert_Update(D_DepositHistory_Entity mre)
        {
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
            {
                ...
                { "@DataKBN", new ValuePair { value1 = SqlDbType.TinyInt, value2 = mre.DataKBN } },
                ...
                { "@AdminNO", new ValuePair { value1 = SqlDbType.Int, value2 = mre.AdminNO } },
                { "@SalesSU", new ValuePair { value1 = SqlDbType.Money, value2 = mre.SalesSU } },
                { "@SalesUnitPrice", new ValuePair { value1 = SqlDbType.Money, value2 = mre.SalesUnitPrice } },
                { "@SalesGaku", new ValuePair { value1 = SqlDbType.Money, value2 = mre.SalesGaku } },
                { "@SalesTax", new ValuePair { value1 = SqlDbType.Money, value2 = mre.SalesTax } },
                { "@TotalGaku", new ValuePair { value1 = SqlDbType.Money, value2 = mre.TotalGaku } },
                { "@Refund", new ValuePair { value1 = SqlDbType.Money, value2 = mre.Refund } },
                ...
                { "@IsIssued", new ValuePair { value1 = SqlDbType.TinyInt, value2 = mre.IsIssued } },
