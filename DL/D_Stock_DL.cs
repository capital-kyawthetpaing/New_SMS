            ...
            Dictionary<string, ValuePair> dic = new Dictionary<string, ValuePair>
               {
                   ...
                   {"@JanCD",new ValuePair { value1=SqlDbType.Int,value2=skue.JanCD} },
                   ...
                   {"@MakerItem",new ValuePair { value1=SqlDbType.Int,value2=skue.MakerItem} },
                   {"@SportsCD",new ValuePair { value1=SqlDbType.VarChar,value2=skue.SportsCD} },
                   {"@ReserveCD",new ValuePair { value1=SqlDbType.Int,value2=skue.ReserveCD} },
                   ...
                   {"@OrderAttentionCD",new ValuePair { value1=SqlDbType.Int,value2=skue.OrderAttentionCD} },
                   {"@YearTerm",new ValuePair { value1=SqlDbType.Int,value2=info.YearTerm} },
                   ...
                   {"@InsturctionsNO",new ValuePair { value1=SqlDbType.Int,value2=info.InstructionsNO} },
                   {"@TagName1",new ValuePair { value1=SqlDbType.Int,value2=tage.TagName1} },
                   {"@TagName2",new ValuePair { value1=SqlDbType.Int,value2=tage.TagName2} },
